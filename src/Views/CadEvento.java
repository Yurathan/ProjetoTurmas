...
public class CadEvento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Sala do evento");
    ...
    private void BTgravaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTgravaActionPerformed
        ...
        if  (sala.getPkSala().equals(-1)) {
            try {
                ...
                sala.setLotação(Integer.parseInt(TFlotacao.getText()));
                salaiterator.adicionaSala(sala);
                TFcodigo.setEditable(true);
                TFcodigo.setText(String.valueOf(salaiterator.buscaPKsala(sala)));
            } catch (Exception ex) {

            }
        } else {
            sala.setPkSala(Integer.parseInt(TFcodigo.getText()));
            sala.setDescrição(TFdescricao.getText());
            sala.setLotação(Integer.parseInt(TFlotacao.getText()));
            try {
                salaiterator.alteraSala(sala);
            } catch (Exception ex) {
